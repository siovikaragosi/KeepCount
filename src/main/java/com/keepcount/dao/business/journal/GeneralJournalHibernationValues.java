...
public class GeneralJournalHibernationValues extends GeneralJournal {
	...
	//
	// public GeneralJournalHibernationValues() {
	//
	// }
	//
	...
	// return "GeneralJournalHibernationValues [id=" + id + ", dateServer=" + dateServer + ",
	// dateClient=" + dateClient + ", particularDr=" + particularDr + ", particularCr="
	// + particularCr + ", narration=" + narration + ", referenceNumber=" + referenceNumber + ",
	// drAmount=" + drAmount + ", drAmountStr=" + drAmountStr + ", crAmount="
	// + crAmount + ", cdAmountStr=" + cdAmountStr + ", itemId=" + itemId + ", transactionId=" +
	// transactionId + "]" ;
	// }
