...
public class User {
	...
	public User(BigDecimal id, String userFirstName, String userLastName, String userPhoneNumber, String userEmail,
	...
	public User(String userFirstName, String userLastName, String userPhoneNumber, String userEmail, String userNIN,
			String imagePathBase64, byte[] userPhoto) {
		super();
		this.userFirstName = userFirstName;
		this.userLastName = userLastName;
		this.userPhoneNumber = userPhoneNumber;
